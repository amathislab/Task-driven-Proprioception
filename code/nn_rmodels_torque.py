...
class ConvRModel():
    ...
    def __init__(self,
            ...
            t_kernelsize, s_stride, t_stride, n_outputs, projector_rl = False, nlayers_fc=None, nunits=None, seed=None, train=True):  #n_outputs,
        ...
        self.nunits = nunits
        self.projector_rl = projector_rl
        self.seed = seed
    ...
    def predict(self, X, target, is_training=True):
        ...
        with tf.variable_scope('Network', reuse=tf.AUTO_REUSE):
            ...
            if self.projector_rl:
                ## Concatenate target
                score = tf.concat([score,target],-1)
...
class RecurrentRModel():
    ...
    def __init__(
            ...
            s_kernelsize, s_stride, n_outputs, projector_rl = False, nlayers_fc=None, nunits=None, seed=None, train=True):  #n_outputs, 
...
class BarlowTwinsRModel_rec():
    ...
    def __init__(self, experiment_id, rec_blocktype, n_recunits, npplayers, nppfilters, 
        ...
        self.s_kernelsize = s_kernelsize
        self.s_stride = s_stride
        self.n_outputs = 3 #n_outputs  ## Added after to remove in case
