...
# Modules
import compute_model_session_predictivity_h5_cv_align_passive

def pool_model_pred(inputs):

    monkey_name, session_date, exp_id, train_iter, model_name, window, latency, active_start, active_length, align, control_dict, shuffle_flag, path_to_act, path_to_results = inputs


    compute_model_session_predictivity_h5_cv_align_passive.main(monkey_name=monkey_name,
...
def main(monkey_name, session_date, exp_id, train_iter=None, active_start='mvt', active_length=0, align=100,
         permut_m=False, permut_t=False, constant_input=False, window=5, latency=0, cv_winlat=False, shuffle_flag=False, path_to_act='..', path_to_results='..'):
    '''
    ...
    all_files = [[monkey_name, session_date, exp_id, train_iter, model_name, window, latency, active_start, active_length, align, control_dict, shuffle_flag, path_to_act, path_to_results] for model_name in model_list]
